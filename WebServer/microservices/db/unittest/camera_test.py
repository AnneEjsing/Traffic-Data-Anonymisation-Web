...
class CamearaUpdateTests(aiounittest.AsyncTestCase):
    ...
    async def test_camera_update_info_pass(self):
        ...
        res = b'{"camera_id": "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11", "description": "test", "label": "test", "ip": "0.0.0.0", "source": "https://test.m3u8", "last_sign_of_life": null, "owner": "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380b12"}'
